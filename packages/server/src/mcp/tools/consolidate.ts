...
export const DESCRIPTION = [
  'Returns a step-by-step plan to promote stabilized research into a canonical article. Does NOT write — you execute the plan after a STOP gate confirms a real decision was made.',
  'Canonical, not provisional — the output becomes the source of truth, with a `supersedes` trail back to the research.',
  'Use when a team has decided after research and wants the outcome committed as authoritative knowledge.',
].join('\n');
